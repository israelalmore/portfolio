...
const PROJECTS = [
  {
    ...
    lang: "TypeScript",
    lc: "#3178c6",
    desc: "REST API built with TypeScript — clean architecture and modern patterns.",
    link: "https://github.com/israelalmore/rest-app",
  },
  {
    name: "FocusHub",
    lang: "JavaScript",
    lc: "#f0c000",
    desc: "Focus hub by students, for students. Built at a Hackathon under real pressure.",
    link: "https://github.com/JorgeCordova9/FocusHub",
  },
  {
    name: "Forever Events",
    lang: "PHP",
    lc: "#8892be",
    desc: "UI/UX design project exploring modern layouts with HTML, CSS and PHP.",
    link: "https://github.com/israelalmore/Forever-Events",
  },
  {
    name: "Alpha Project",
    lang: "Java",
    lc: "#f89820",
    desc: "Team Java project — experimenting with backend architecture and OOP patterns.",
    link: "https://github.com/israelalmore/alpha-project",
  },
];
    ...
    <div style={S.root}>
      <nav style={S.nav}>
        ...
        <div style={{ display: "flex", gap: "2.5rem" }}>
          {["about", "stack", "projects", "contact"].map((id) => (
            <button key={id} className="nav-link" style={S.navBtn} onClick={() => go(id)}>
              {id}
            </button>
          ))}
        </div>
      ...
      <section id="home" style={S.hero}>
        <div style={{ position: "absolute", inset: 0, overflow: "hidden", pointerEvents: "none" }}>
          ...
          <div
            style={{
              ...
              height: 320,
              borderRadius: "50%",
              background: "radial-gradient(circle,rgba(0,196,255,.035) 0%,transparent 70%)",
        ...
        <div style={{ position: "relative", zIndex: 1, maxWidth: 950 }}>
          <p className="fu1" style={{ fontFamily: "monospace", fontSize: "0.85rem", color: "#00ff88", letterSpacing: "3px", marginBottom: "1.2rem" }}>
            // Hello World — I'm
          </p>
          <h1 className="fu2" style={{ fontSize: "clamp(3.5rem,11vw,8.5rem)", fontWeight: 900, lineHeight: 1, letterSpacing: "-4px", marginBottom: "1.2rem" }}>
            Israel
            <br />
            <span style={{ color: "#00ff88" }}>Alcántara</span>
          </h1>
          <p
            className="fu3"
            style={{ fontSize: "clamp(1rem,1.8vw,1.3rem)", color: "rgba(255,255,255,.4)", fontWeight: 300, marginBottom: "1rem", fontFamily: "monospace" }}>
            {text}
            <span className="cursor">|</span>
          </p>
          <p className="fu3" style={{ fontSize: "1rem", color: "#b3b3b3", maxWidth: 460, lineHeight: 1.85, marginBottom: "2.5rem" }}>
            DAW Student @ Stucom Barcelona · Building things that matter. 26 repos and counting. ☕
          </p>
        ...
        <div style={{ position: "absolute", bottom: "3rem", left: "7%", display: "flex", alignItems: "center", gap: "0.6rem" }}>
          ...
          <span style={{ fontFamily: "monospace", fontSize: "0.65rem", color: "rgba(255,255,255,.25)", letterSpacing: "2px", writingMode: "vertical-lr" }}>
            SCROLL
          </span>
        </div>
      </section>
      ...
      <section id="about" style={S.section}>
        ...
        <h2 style={S.secH2}>
          Building the web,
          <br />
          <span style={{ color: "rgba(255,255,255,.25)" }}>one commit at a time.</span>
        </h2>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "4rem", alignItems: "start" }}>
          <div>
            <p style={{ color: "#b3b3b3", lineHeight: 1.9, marginBottom: "1.4rem" }}>
              19 years old, Barcelona. Studying <strong style={{ color: "#fff" }}>Web Application Development (DAW)</strong> at Stucom. I learn by building,
              break things, and start again.
            </p>
            <p style={{ color: "#b3b3b3", lineHeight: 1.9 }}>
              Competed in a <strong style={{ color: "#fff" }}>Hackathon</strong> and would do it again. Goal: become a well-rounded developer and build things
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem" }}>
            {STATS.map(([n, l]) => (
              <div
                ...
                <div style={{ fontSize: "0.7rem", color: "rgba(255,255,255,.35)", fontFamily: "monospace", marginTop: "0.4rem", letterSpacing: "1.5px" }}>
                  {l}
                </div>
              </div>
            ))}
          ...
          {PROJECTS.map((p) => (
            <div
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                ...
                <a href={p.link} target="_blank" rel="noreferrer" style={{ color: "rgba(255,255,255,.25)" }}>
                  <IconExternal />
                </a>
              </div>
              ...
              <a
                ...
                style={{ fontSize: "0.8rem", color: "rgba(255,255,255,.3)", fontFamily: "monospace", textDecoration: "none", transition: "color .2s" }}>
                View repo →
              </a>
            </div>
          ))}
      ...
      <section id="contact" style={{ ...S.section, background: "rgba(255,255,255,.01)", textAlign: "center" }}>
        ...
        <div style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap" }}>
          <a
            href="mailto:israelalmore@gmail.com"
            className="btn-green"
            style={{
